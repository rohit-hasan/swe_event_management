...
<div style="margin-top:100px;margin-left: 100px ">
   <table border="3" cellspacing="10">
    <tr><th>Program Name</th><th>Date</th><th>First Approval</th><th>Second Approval</th><th>Download Form</th></tr>
    <?php 
    include 'connection.php';
    global $con;
    $user_id=$_SESSION['user_id'];
    $select_form="select * from form where user_id='$user_id' order by 1 DESC";
    ...
    ?>
    <tr><td><?php echo $programName; ?></td><td><?php echo $date; ?></td><td><?php echo $status1; ?></td><td><?php echo $status2; ?></td>
      <?php if($download==1){
      echo "<td><a href='download_app2.php?form_id= $form_id'>Click Here</a></td>";
      }else{
