...
<div class="apply">
	...
	<form method="post">
		...
		<tr><th>Re-enter Password:</th><td><input type="password" name="r_password"></td></tr>
		<tr><th>Mobile:</th><td><input type="text" name="mobile"></td></tr>
		<tr></tr>
		<tr><td></td><td style="float:right"><button type="submit" name="register" id='register'>Register</button></td></tr>
